        ...
        <Grid item xl={12} lg={12} md={12}>
            <Grid container direction="row" justify="space-between" className={`${classes.card} ${classes.cardIron}`}>
                ...
                <Grid item xl={8} lg={8} md={8} sm={8} xs={12}>
                    ...
                    <a href="https://www.bcc.kz/ironcard?utm_source=bcc&utm_medium=button_click&utm_campaign=cards#order" id="ironCardOrder" className={classes.button} target="_blank">Заказать карту</a>
                    <a href="https://www.bcc.kz/ironcard?utm_source=bcc&utm_medium=button_click&utm_campaign=cards" id="ironCardDetail" className={`${classes.button} ${classes.buttonSecond} ${classes.iron}`} target="_blank">Подробнее о карте</a>
                </Grid>
            </Grid>
        </Grid>
        <Grid item xl={12} lg={12} md={12}>
            <Grid container direction="row" justify="space-between" className={classes.card}>
                ...
                <Grid item xl={8} lg={8} md={8} sm={8} xs={12}>
                    ...
                    <a href="https://www.bcc.kz/kartakarta?utm_source=bcc&utm_medium=button_click&utm_campaign=cards#order" id="kartakartaOrder" className={classes.button} target="_blank">Заказать карту</a>
                    <a href="https://www.bcc.kz/kartakarta?utm_source=bcc&utm_medium=button_click&utm_campaign=cards" id="kartakartaDetail" className={`${classes.button} ${classes.buttonSecond} ${classes.btnGreen}`} target="_blank">Подробнее о карте</a>
                </Grid>
            </Grid>
        </Grid>
        <Grid item xl={12} lg={12} md={12}>
